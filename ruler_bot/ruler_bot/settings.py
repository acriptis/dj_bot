"""
Django settings for hello_bot project.
...
SECRET_KEY = '^jzdznr$p)$af6!h+wwrlz-3#=q)49re#lhm-%s!0@=ouapb%oqq'
...
WSGI_APPLICATION = 'ruler_bot.wsgi.application'
...
# }
#
_MONGODB_NAME = "ruler_bot"
_MONGOHOST = "localhost"
_MONGOPORT = "27017"
DATABASES = {
       'default': {
           'ENGINE': 'djongo',
           # 'NAME': 'ruler_dialog_system',
           'NAME': _MONGODB_NAME,
...
mongoengine.connect(_MONGODB_NAME, host='%s:%s' % (_MONGOHOST, _MONGOPORT))
#
