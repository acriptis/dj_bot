...
class SlotsManager():
    """Manager which registers and manages Slots as Schema to allow sharing Slots between
    multiple Skills.

    So the Manager provides interface for all components to retrieve actual version of
    slot's schema instance from
        string name,
        class
