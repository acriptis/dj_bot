...
class InformationController():
    ...
    def retrospect_or_retrieve_slot(self, slot_spec, target_uri=None, callback=None):
        """
        ...
        try:
            ...
            self.DialogPlanner.plan_process_retrieve_slot_value_with_slot_spec_instance(slot_spec_obj, priority=10, callback_fn=callback, target_uri=target_uri, duplicatable=False)
